    ...
    options: {
      ...
      scales: {
        ...
        yAxes: [{
            ...
            scaleLabel: {
              display: true,
              labelString: 'Total Supply (0xDiary)',
...
async function updateDifficultyGraph(eth, num_days, num_search_points){
  ...
  */
  ...
  // var a = await eth.getStorageAt('0x6056247D57fBF1e7d2CA01b9B2AC03a12061221B', new Eth.BN('20', 10), 'latest');
  // var b = await eth.getStorageAt('0x6056247D57fBF1e7d2CA01b9B2AC03a12061221B', new Eth.BN('20', 10), 'earliest');
  // console.log(a, b);
  ...
  //       capture all difficulty changes. For 0xDIARY once/day is more than
  //       enough.
